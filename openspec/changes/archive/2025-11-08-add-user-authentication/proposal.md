...
- Distinguish between client types (Creative Services, Software Services, Full Service, One-Time)
- Enforce role-based access control for internal team members (Creative, Technical, Operations teams)
...
- Build invitation system for client onboarding (different invite links create different client types)
...
- **Affected code**:
  ...
  - `apps/web/src/components/auth/` - Login, signup, invitation acceptance components
- **Dependencies**: BetterAuth, Drizzle ORM, Neon Postgres
- **Security**: Critical - all data access depends on proper authentication and authorization
