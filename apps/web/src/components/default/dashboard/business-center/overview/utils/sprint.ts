import { ON_TRACK_TOLERANCE } from '@/components/default/dashboard/business-center/overview/constants/sprint-config';
...
export function getRemainingWork(burndownData: readonly { value: number }[] | undefined): number {
  ...
  return burndownData[burndownData.length - 1]?.value;
}
