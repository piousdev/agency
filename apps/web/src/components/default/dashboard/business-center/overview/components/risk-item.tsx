...
import {
  SEVERITY_CONFIG,
  CATEGORY_CONFIG,
} from '@/components/default/dashboard/business-center/overview/constants/risk-config';
import {
  getCategoryIcon,
  getProjectUrl,
} from '@/components/default/dashboard/business-center/overview/utils/risk';
import { Badge } from '@/components/ui/badge';
import { cn } from '@/lib/utils';

import type { RiskIndicator } from '@/components/default/dashboard/business-center/overview/types';
