...
import { MOCK_TASKS } from '@/components/default/dashboard/business-center/overview/constants/t-mock-data';
import { useOverviewData } from '@/components/default/dashboard/business-center/overview/context/overview-data-context';
import { isOverdue } from '@/components/default/dashboard/business-center/overview/utils/task';
...
function transformServerTask(serverTask: {
  ...
  return {
    ...
    isBlocked: serverTask.isBlocked,
  };
}
