...
import type { MiniBarChartProps } from '@/components/default/dashboard/business-center/overview/shared/components/sparkline-chart/types';
...
export function MiniBarChart({
  ...
  return (
    <div className={cn('flex items-end gap-1', className)} style={{ height }}>
      {data.map((d, i) => (
        <div
          // eslint-disable-next-line react/no-array-index-key -- Static chart bars
          key={i}
