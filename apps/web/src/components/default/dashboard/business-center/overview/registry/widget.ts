...
import { SKELETON_REGISTRY } from '@/components/default/dashboard/business-center/overview/registry/skeleton';
import { withSuspense } from '@/components/default/dashboard/business-center/overview/utils/with-suspense';
 ...
 * @deprecated Not currently used, but kept for future extensibility
 */
function _createLazyWidget(importPath: string, exportName: string): LazyWidgetComponent {
  ...
  const importMap: Record<string, () => Promise<Record<string, ComponentType>>> = {
    'my-work-today': () =>
      import('@/components/default/dashboard/business-center/overview/widgets/my-work-today'),
    'upcoming-deadlines': () =>
      import('@/components/default/dashboard/business-center/overview/widgets/upcoming-deadlines'),
    'recent-activity': () =>
      import('@/components/default/dashboard/business-center/overview/widgets/recent-activity'),
    'current-sprint': () =>
      import('@/components/default/dashboard/business-center/overview/widgets/current-sprint'),
    'organization-health': () =>
      import('@/components/default/dashboard/business-center/overview/widgets/organization-health'),
    'team-status': () =>
      import('@/components/default/dashboard/business-center/overview/widgets/team-status'),
    blockers: () =>
      import('@/components/default/dashboard/business-center/overview/widgets/blockers'),
    'financial-snapshot': () =>
      import('@/components/default/dashboard/business-center/overview/widgets/financial-snapshot'),
    'risk-indicators': () =>
      import('@/components/default/dashboard/business-center/overview/widgets/risk-indicators'),
    'critical-alerts': () =>
      import('@/components/default/dashboard/business-center/overview/widgets/critical-alerts'),
    'communication-hub': () =>
      import('@/components/default/dashboard/business-center/overview/widgets/communication-hub'),
  };
  ...
  return lazy(() =>
    importFn().then((mod) => {
      ...
      if (!component) {
        throw new Error(`Export "${exportName}" not found in widget module "${importPath}"`);
      }
...
const LAZY_WIDGETS: Readonly<Record<WidgetType, LazyWidgetComponent>> = {
  'my-work-today': lazy(() =>
    import('@/components/default/dashboard/business-center/overview/widgets/my-work-today').then(
      (mod) => ({
  ...
  'upcoming-deadlines': lazy(() =>
    import(
      '@/components/default/dashboard/business-center/overview/widgets/upcoming-deadlines'
    ).then((mod) => ({
      default: mod.UpcomingDeadlinesWidget,
    }))
  ),
  'recent-activity': lazy(() =>
    import('@/components/default/dashboard/business-center/overview/widgets/recent-activity').then(
      (mod) => ({
  ...
  'current-sprint': lazy(() =>
    import('@/components/default/dashboard/business-center/overview/widgets/current-sprint').then(
      (mod) => ({
  ...
  'organization-health': lazy(() =>
    import(
      '@/components/default/dashboard/business-center/overview/widgets/organization-health'
    ).then((mod) => ({
      default: mod.OrganizationHealthWidget,
    }))
  ),
  'team-status': lazy(() =>
    import('@/components/default/dashboard/business-center/overview/widgets/team-status').then(
      (mod) => ({
  ...
  blockers: lazy(() =>
    import('@/components/default/dashboard/business-center/overview/widgets/blockers').then(
      (mod) => ({
  ...
  'financial-snapshot': lazy(() =>
    import(
      '@/components/default/dashboard/business-center/overview/widgets/financial-snapshot'
    ).then((mod) => ({
      default: mod.FinancialSnapshotWidget,
    }))
  ),
  'risk-indicators': lazy(() =>
    import('@/components/default/dashboard/business-center/overview/widgets/risk-indicators').then(
      (mod) => ({
  ...
  'critical-alerts': lazy(() =>
    import('@/components/default/dashboard/business-center/overview/widgets/critical-alerts').then(
      (mod) => ({
  ...
  'communication-hub': lazy(() =>
    import(
      '@/components/default/dashboard/business-center/overview/widgets/communication-hub'
    ).then((mod) => ({
