...
interface TableProps extends React.ComponentProps<'table'> {
  /**
   * Disable overflow-x-auto on the container.
   * Required for @hello-pangea/dnd compatibility - the library cannot calculate
   * drop positions correctly when the Droppable is inside a scroll container.
   */
