...
import type { AnimationConfig } from '@/components/dashboard/business-center/overview/shared/type';
import { ANIMATION_DEFAULTS } from '@/components/dashboard/business-center/overview/shared/constants/skeleton';
import {
  WIDGET_TYPES,
  type WidgetSkeletonMap,
  type WidgetType,
  type SkeletonComponent,
} from '@/components/dashboard/business-center/overview/shared/type';
 ...
 */
export const createSkeletonRange = (length: number): ReadonlyArray<number> =>
 ...
 */
export const combineClasses = (...classes: ReadonlyArray<string | undefined>): string =>
