...
import type { IconContainerSize } from '@/components/dashboard/business-center/overview/shared/components/widget-error/types';
import {
 ...
 */
export const formatErrorMessage = (message: string, maxLength: number = 100): string => {
