...
import type { WidgetEmptyProps } from '@/components/dashboard/business-center/overview/shared/components/widget-error/types';
import {
  STATE_ARIA_LABELS,
  STATE_CLASSES,
} from '@/components/dashboard/business-center/overview/shared/components/widget-error/constants';
import { shouldShowAction } from '@/components/dashboard/business-center/overview/shared/components/widget-error/utils';
