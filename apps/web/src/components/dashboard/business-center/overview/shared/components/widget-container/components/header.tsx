...
} from '@/components/dashboard/business-center/overview/shared/components/widget-container/type';
import {
  WIDGET_ARIA_LABELS,
  WIDGET_MENU_LABELS,
  WIDGET_CLASSES,
...
import {
  ...
  hasActions,
} from '@/components/dashboard/business-center/overview/shared/components/widget-container/utils';
