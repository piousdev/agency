...
import type { ConnectionDotProps } from '@/components/dashboard/business-center/overview/shared/components/connection-status/types';
...
import { getDotColor } from '@/components/dashboard/business-center/overview/shared/components/connection-status/utils';
